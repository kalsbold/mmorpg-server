...
public struct Reply_MoveZoneSuccess : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static Reply_MoveZoneSuccess GetRootAsReply_MoveZoneSuccess(ByteBuffer _bb) { return GetRootAsReply_MoveZoneSuccess(_bb, new Reply_MoveZoneSuccess()); }
  public static Reply_MoveZoneSuccess GetRootAsReply_MoveZoneSuccess(ByteBuffer _bb, Reply_MoveZoneSuccess obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p.bb_pos = _i; __p.bb = _bb; }
  public Reply_MoveZoneSuccess __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void StartReply_MoveZoneSuccess(FlatBufferBuilder builder) { builder.StartObject(3); }
  ...
  public static Offset<Reply_MoveZoneSuccess> EndReply_MoveZoneSuccess(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<Reply_MoveZoneSuccess>(o);
  }
};
