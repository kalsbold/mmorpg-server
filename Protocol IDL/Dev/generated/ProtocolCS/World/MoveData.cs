...
public struct MoveData : IFlatbufferObject
{
  ...
  public static void StartMoveData(FlatBufferBuilder builder) { builder.StartObject(4); }
  ...
  public static Offset<MoveData> EndMoveData(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<MoveData>(o);
  }
};
