...
public struct PlayerCharacter : IFlatbufferObject
{
  ...
  public protocol.Vec3? Pos { get { int o = __p.__offset(26); return o != 0 ? (protocol.Vec3?)(new protocol.Vec3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public float RotationY { get { int o = __p.__offset(28); return o != 0 ? __p.bb.GetFloat(o + __p.bb_pos) : (float)0.0f; } }
  ...
  public static void AddPos(FlatBufferBuilder builder, Offset<protocol.Vec3> posOffset) { builder.AddStruct(11, posOffset.Value, 0); }
  public static void AddRotationY(FlatBufferBuilder builder, float rotationY) { builder.AddFloat(12, rotationY, 0.0f); }
