...
public struct MoveInfo : IFlatbufferObject
{
  ...
  public static MoveInfo GetRootAsMoveInfo(ByteBuffer _bb) { return GetRootAsMoveInfo(_bb, new MoveInfo()); }
  public static MoveInfo GetRootAsMoveInfo(ByteBuffer _bb, MoveInfo obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public static void StartMoveInfo(FlatBufferBuilder builder) { builder.StartObject(4); }
  ...
  public static Offset<MoveInfo> EndMoveInfo(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<MoveInfo>(o);
  }
};
