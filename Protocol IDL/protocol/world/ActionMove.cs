...
public struct ActionMove : IFlatbufferObject
{
  ...
  public protocol.Vec3? Velocity { get { int o = __p.__offset(8); return o != 0 ? (protocol.Vec3?)(new protocol.Vec3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  ...
  public static void AddVelocity(FlatBufferBuilder builder, Offset<protocol.Vec3> velocityOffset) { builder.AddStruct(2, velocityOffset.Value, 0); }
