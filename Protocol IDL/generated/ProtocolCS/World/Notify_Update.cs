...
public struct Notify_Update : IFlatbufferObject
{
  ...
  public UpdateType UpdateDataType { get { int o = __p.__offset(4); return o != 0 ? (UpdateType)__p.bb.Get(o + __p.bb_pos) : UpdateType.NONE; } }
  public bool MutateUpdateDataType(UpdateType update_data_type) { int o = __p.__offset(4); if (o != 0) { __p.bb.Put(o + __p.bb_pos, (byte)update_data_type); return true; } else { return false; } }
  public TTable? UpdateData<TTable>() where TTable : struct, IFlatbufferObject { int o = __p.__offset(6); return o != 0 ? (TTable?)__p.__union<TTable>(o) : null; }
  ...
  public static void StartNotify_Update(FlatBufferBuilder builder) { builder.StartObject(2); }
  public static void AddUpdateDataType(FlatBufferBuilder builder, UpdateType updateDataType) { builder.AddByte(0, (byte)updateDataType, 0); }
  public static void AddUpdateData(FlatBufferBuilder builder, int updateDataOffset) { builder.AddOffset(1, updateDataOffset, 0); }
