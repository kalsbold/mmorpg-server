...
public struct SkillInfo : IFlatbufferObject
{
  ...
  public int Skill { get { int o = __p.__offset(6); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public bool MutateSkill(int skill) { int o = __p.__offset(6); if (o != 0) { __p.bb.PutInt(o + __p.bb_pos, skill); return true; } else { return false; } }
  ...
  public static Offset<SkillInfo> CreateSkillInfo(FlatBufferBuilder builder,
    ...
    SkillInfo.AddSkill(builder, skill);
  ...
  public static void AddSkill(FlatBufferBuilder builder, int skill) { builder.AddInt(1, skill, 0); }
