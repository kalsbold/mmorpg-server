...
public struct LocalCharacter : IFlatbufferObject
{
  ...
  public protocol.Vec3? Pos { get { int o = __p.__offset(28); return o != 0 ? (protocol.Vec3?)(new protocol.Vec3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  ...
  public static void AddPos(FlatBufferBuilder builder, Offset<protocol.Vec3> posOffset) { builder.AddStruct(12, posOffset.Value, 0); }
