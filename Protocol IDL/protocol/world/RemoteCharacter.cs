...
public struct RemoteCharacter : IFlatbufferObject
{
  ...
  public Vec3? Pos { get { int o = __p.__offset(20); return o != 0 ? (Vec3?)(new Vec3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  ...
  public static void AddPos(FlatBufferBuilder builder, Offset<Vec3> posOffset) { builder.AddStruct(8, posOffset.Value, 0); }
